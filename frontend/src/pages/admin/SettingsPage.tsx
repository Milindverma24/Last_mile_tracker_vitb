    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200/80 pb-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleSave}
            className="inline-flex items-center gap-1.5 rounded-xl bg-indigo-600 px-4 py-2 text-xs font-bold text-white shadow-2xs hover:bg-indigo-500 transition cursor-pointer"
          >
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-slate-50 p-2 text-xs font-semibold text-slate-800 focus:border-indigo-600 focus:bg-white focus:outline-none"
                >
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="font-mono font-bold text-indigo-600">{maxRadiusKm} km</span>
                </div>
                <input
                  type="range"
                  min="3"
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-24 rounded-xl border border-slate-200 bg-slate-50 p-2 font-mono font-bold text-slate-900 text-xs focus:border-indigo-600 focus:bg-white focus:outline-none"
                  />
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-32 rounded-xl border border-slate-200 bg-slate-50 p-2 font-mono font-bold text-slate-900 text-xs focus:border-indigo-600 focus:bg-white focus:outline-none"
                  />
                  <span className="text-[11px] text-slate-500">Standard: <strong>5000 cm³/kg</strong></span>
                </div>
              </div>

              <div className="rounded-xl bg-indigo-50/70 border border-indigo-100 p-3 text-[11px] text-indigo-900 font-mono">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 p-2 font-mono font-bold text-slate-900 text-xs focus:border-indigo-600 focus:bg-white focus:outline-none"
                  />
                </div>
                <div>
            ...
            <div className="space-y-3 text-xs">
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="font-mono font-bold text-indigo-600">{telemetryBroadcastInterval} seconds</span>
                </div>
                <input
                  type="range"
                  min="2"
